        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-end">
            <li class="page-item disabled">
              <a class="page-link" href="{{ url('/image_files/'.$product->image_url) }}" tabindex="-1">Previous</a>
            </li>
            <li class="page-item"><a class="page-link" href="{{ url('/image_files/'.$product->image_url) }}">1</a></li>
            <li class="page-item"><a class="page-link" href="{{ url('/image_files/'.$product->image_url) }}">2</a></li>
            <li class="page-item"><a class="page-link" href="{{ url('/image_files/'.$product->image_url) }}">3</a></li>
            <li class="page-item">
              <a class="page-link" href="{{ url('/image_files/'.$product->image_url) }}">Next</a>
            </li>
          </ul>
        </nav>
